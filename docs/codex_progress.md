...
| Next action | Required PR #43 checks must pass on the exact final Head, then squash merge under the user's explicit authorization. Do not create a post-merge checkpoint PR and do not move or replace `phase-14-complete` |
